...
const IndividualAward =(props)=>{
   ...
   return  <>
        {props.individualAward.length > 0 && (
    <FullpageSection
    ...
    >
      ...
      >
        ...
        >
          <>
            <Grid item xs="12">
              <div className="navigators">Individual Award</div>
            </Grid>
            {props.individualAward.map((each) => {
...
export default IndividualAward
